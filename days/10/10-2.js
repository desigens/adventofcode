...
let inputAsString = fs.readFileSync(
    path.join(__dirname, "./input.txt"),
    "utf-8"
);
// inputAsString = '';
// inputAsString = 'AoC 2017';
// inputAsString = '1,2,3';
// inputAsString = '1,2,4';
...
const lengths = toASCIICodesWithSuffix(inputAsString).map(i => parseInt(i, 10));
...
// console.log("--AFTER 64 ROUNDS--");
// console.log("RESULT:", list[0] * list[1]);
// console.log("CURRENT POSITION:", listCursorPosition);
// console.log("CURRENT SKIP SIZE:", skipSize);

// console.log("SPARSE HASH:", list.toString());
...
// console.log("DENSE HASH:", denseHash.toString());

const denseHashHEX = denseHash.reduce((sum, i) => {
    sum = sum + ('0' + i.toString(16)).slice(-2);
    return sum;
}, "");
console.log("DENSE HASH HEX:", denseHashHEX);
